...
export const MODELS: ModelInfo[] = [
  ...
  { id: 'zhipu', displayName: 'GLM-4.7 FlashX', subtitle: 'Zhipu AI', provider: 'Zhipu', keySource: 'byok', apiFormat: 'openai', docsUrl: 'https://open.bigmodel.cn/usercenter/apikeys' },
