      ...
      <div className="space-y-6 font-mono text-sm leading-relaxed text-dim-light">
        ...
        <div className="border border-surface-light p-4 space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div>
              <span className="text-arena-purple">Claude 4.5 Haiku</span>{' '}
              <span className="text-dim">&mdash; Anthropic (96 tok/s)</span>
            </div>
            <div>
            ...
            <div>
              <span className="text-arena-yellow">GLM-4.7 FlashX</span>{' '}
              <span className="text-dim">&mdash; Zhipu AI (100+ tok/s)</span>
            </div>
            <div>
